...
public class FutbolH2 {
    ...
    private static final String DB_URL = "jdbc:h2:file:~/data/furbo";
    private static final String USER = "sa";
    private static final String PASS = "";
    // Ruta del archivo XML
    private static final String XML_FILE_PATH = "C:\\Users\\Alumno1\\Documents\\Cuevas\\2ndo-DAM\\Acceso a Datos\\actividad456\\src\\main\\java\\com\\example\\marcadores.xml";

    // Método principal
    public static void main(String[] args) {
        SpringApplication.run(FutbolH2.class, args);
        
        try (Connection connection = DriverManager.getConnection(DB_URL, USER, PASS)) {
            crearTablas(connection);
            importarXML(connection, XML_FILE_PATH);
            ...
            while (true) {
                ...
                int eleccion = seleccionUsuario(scanner);
    ...
    private static int seleccionUsuario(Scanner scanner) {
    ...
    private static void importarXML(Connection connection, String rutaArchivoXML) {
        try {
